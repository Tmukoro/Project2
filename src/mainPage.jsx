...
const MainPage = () => {
  ...
  return (
    ...
    >
      ...
      <Box bg={"#ad06af"} w={"60px"} h={"630px"} float={"left"}>
        <Text
          fontWeight={"bold"}
          fontSize={20}
          color={"white"}
      ...
      <Box bg={"blue"} w={"1100px"} h={"630px"}>
        ...
        <Box bg={"red"} w={"700px"} h={"630px"} float={"left"}>
          <Box bg={"white"} h={"100px"} w={"700px"}>
            <Flex gap={2} p={4}>
              <Text fontWeight={"bold"} fontSize={20} color={"black"} pt={0.5}>
                Task Schedule
              </Text>
              <Button
                variant="plain"
                    ...
                    <Table.Root size="sm" stickyHeader >
                      <Table.Header>
                        <Table.Row bg={"white"}>
                          ...
                          <Table.ColumnHeader color={"black"} w={"50px"}>
                            Action
                          </Table.ColumnHeader>
                        </Table.Row>
                      </Table.Header>
                      <Table.Body>
                        {tasks.map((task) => (
                          <Table.Row
                            key={task.id}
                            bg={
                              selectedTask?.id === task.id ? "#f4f4f4" : "white"
                            }
                            _hover={{
                              bg:
                          ...
                          >
                            ...
                            <Table.Cell onClick={(e) => e.stopPropagation()}>
                              <Select.Root
                                ...
                                onValueChange={(details) =>
                                  toggleTaskStatus(task.id, details.value)
                                }
                              >
                                <Select.Control>
                                  <Select.Trigger
                            ...
                            <Table.Cell color={"black"} alignSelf={"end"}>
                              {task.assignee}
                            </Table.Cell>
                            <Table.Cell onClick={(e) => e.stopPropagation()}>
                              <Button
                                ...
                                variant="ghost"
                                onClick={() =>
                                  handleRemoveTask(task.id, task.name)
                                }
                              >
                                <MdDelete />
                              </Button>
        ...
        <Box bg={"red"} w={"340px"} h={"630px"} float={"left"}>
          {selectedTask ? (
            <Box bg={"white"} p={4} h={"100%"} pt={10}>
              <Text fontSize={18} fontWeight={"bold"} color={"black"} mb={4}>
                Task Details
              </Text>
